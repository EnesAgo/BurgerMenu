        ...
        <div style={{ backgroundImage: "url('/hamburgerVectors.svg')" }} className={"w-full h-full bg-cover flex items-center justify-center"}>
            ...
            <div className={"h-full flex flex-col justify-between items-stretch max-w-[40%] [@media(min-width:1600px)]:max-w-[50%]"}>
                ...
                <div className={"w-full h-full p-8 gap-5 flex flex-col justify-around "}>
                    <div className="absolute bottom-[-35%] left-[-50%] h-[100%] w-[100%] aspect-[2] bg-[#328C201A] blur-xs rounded-full z-0"></div>

                    <h1 className={" z-10 color-[#FEC100] font-[Katibeh] pl-8 text-5xl"}>Drinks</h1>
